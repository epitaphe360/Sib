...
export default function ServiceClientZoneCapacityScreen() {
    ...
    <Screen>
      ...
      >
        ...
        <View style={styles.totalCard}>
          ...
          <Text style={styles.totalPct}>{totalMax > 0 ? Math.round((totalCurrent / totalMax) * 100) : 0}% de remplissage</Text>
        </View>
