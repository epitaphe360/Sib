...
-- Article 2: Cybersécurité Portuaire 2025
UPDATE news_articles SET
...
<p>Port cybersecurity in 2025 is no longer optional—it is strategic imperative. Cyberattacks can paralyze entire national economies and compromise commercial confidentiality. Investing massively in cybersecurity is not a cost but essential insurance for the future of global maritime trade.</p>'
WHERE id = 2;

-- Article 3: L'IoT révolutionne les ports en 2025
UPDATE news_articles SET
...
<p>Rotterdam Port estimates annual savings of €50 million thanks to predictive maintenance.</p>
...
<p>The Internet of Things is not a futuristic trend—it is already port operational reality in 2025. Ports investing in this technology gain competitiveness, operational efficiency, and resilience. Others risk obsolescence in an increasingly connected, demanding world.</p>'
WHERE id = 3;
...
<p>Blockchain is not a buzzword—it is a transformative technology for maritime logistics. Ports investing now in this infrastructure gain decisive competitive advantage. In 2025, the question is no longer "should we adopt blockchain?" but "how quickly can we deploy it?"</p>'
WHERE id = 4;
...
UPDATE news_articles SET
  ...
  content_en = '<p>Nador West Med (NWM), inaugurated in stages since 2023, represents one of Morocco's most ambitious infrastructure projects. Located on the mé Mediterranean coast, this deepwater port is designed to become a major logistics crossroads between three continents.</p>
...
<ul>
  <li>70 km from Spanish coast (Almerí)</li>
...
<p>Tanger Med is no longer just a promise—it''s a tangible success. By continuing infrastructure investments, connectivity improvements, and enhanced regional integration, Morocco has positioned this port as an essential pillar of its economy and an African model to emulate.</p>'
WHERE id = 6;

-- Article 7: Stratégie Portuaire 2030 Maroc
UPDATE news_articles SET
...
<ul>
  ...
  <li><strong>Kénitra Atlantic Port:</strong> Entry point for Oriental region industries</li>
...
<p>Morocco''s 2030 Port Strategy transcends national infrastructure—it''s a continental vision positioning the Kingdom as Africa''s maritime gateway. If ambitions materialize, Morocco could dominate African logistics and become essential Europe-Africa-Americas commercial hub.</p>'
WHERE id = 7;
...
UPDATE news_articles SET
  ...
  content_en = '<p>Atlantic Africa—stretching from Morocco to South Africa—represents 15,000+ km of coastline and vast economic potential. Yet despite maritime resources, the region remains fragmented, with competing ports undermining collective emergence as true maritime power.</p>
...
<p>Morocco''s 2024 port performance is no accident—it''s the fruit of long-term vision, massive investments, and clear strategy. To maintain leadership, Morocco must pursue modernization, expand capacity, and improve hinterland connectivity. The momentum is strong; sustaining it is the true challenge.</p>'
WHERE id = 9;
