...
export const Header: React.FC = memo(() => {
  ...
  return (
      ...
      className={`fixed ${isHomePage ? 'top-0' : 'top-8'} left-0 right-0 z-[200] transition-all duration-500 ${
        ...
        isHomeOverlay
          ...
          : isHomePage && isMenuOpen
            ? 'bg-[#001A3D]/97 backdrop-blur-md border-b border-transparent shadow-lg'
            : isTransparent
    ...
    >
      {!isHomeOverlay && (
        <div className="absolute inset-0 opacity-[0.015] pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, rgba(46,89,132,0.4) 1px, transparent 0)', backgroundSize: '20px 20px' }} />
      )}
            ...
            <div className="relative">
              ...
              <div className="relative w-auto flex items-center">
                <img
                  ...
                  className={`h-14 sm:h-18 xl:h-24 w-auto object-contain${isHomeOverlay ? ' drop-shadow-[0_2px_8px_rgba(0,0,0,0.35)]' : ''}`}
                />
              </div>
            </div>
          </Link>
