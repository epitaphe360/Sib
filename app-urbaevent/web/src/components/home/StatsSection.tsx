...
export const StatsSection: React.FC = () => {
  ...
  return (
    <section className="relative py-24 bg-white overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-[0.5px]" style={{ background: 'rgba(243,146,0,0.25)' }} />
            ...
            >
              ...
              <div className="luxury-card p-8 sm:p-10 flex flex-col items-center">
                ...
                <div className="mb-5 p-3 rounded-sm"
                  style={{ background: 'rgba(243,146,0,0.08)', border: '0.5px solid rgba(243,146,0,0.2)' }}>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[0.5px]" style={{ background: 'rgba(243,146,0,0.25)' }} />
    </section>
  );
};
