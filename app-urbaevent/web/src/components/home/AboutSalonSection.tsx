 ...
 * Design SIB Bâtiment — navy/orange, pas maritime
 */
...
export const AboutSalonSection: React.FC = () => {
  ...
  return (
    <section className="py-28 bg-[#F8F9FA] relative overflow-hidden">
      ...
      <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse 60% 40% at 80% 20%, rgba(243,146,0,0.04) 0%, transparent 65%)' }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="mb-8">
              <div className="flex items-center space-x-3 mb-5">
                <div className="p-2 rounded-sm" style={{ background: 'rgba(243,146,0,0.15)', border: '0.5px solid rgba(243,146,0,0.4)' }}>
                  <Building2 className="h-5 w-5" style={{ color: '#F39200' }} />
                </div>
                <span className="text-xs font-light tracking-[0.18em] uppercase" style={{ color: '#F39200' }}>{t('about.badge')}</span>
              </div>
              <h2 className="text-3xl lg:text-5xl font-light text-[#1A1A1A] mb-6" style={{ fontFamily: '"Cormorant Garamond", serif' }}>
                SIB 2026 — <span style={{ color: '#F39200' }}>{t('home.about_subtitle')}</span>
              </h2>
          ...
          >
            ...
            <div className="relative z-10 rounded-sm p-8 text-white shadow-luxury"
              style={{ background: 'linear-gradient(135deg, #141414 0%, #0A0A0A 100%)', border: '0.5px solid rgba(243,146,0,0.2)' }}>
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 rounded-sm" style={{ background: 'rgba(243,146,0,0.12)', border: '0.5px solid rgba(243,146,0,0.3)' }}>
                  <Building2 className="h-6 w-6" style={{ color: '#2E5984' }} />
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {stats.map((stat, index) => (
                  <motion.div
                    ...
                    style={{ background: 'rgba(255,255,255,0.05)', borderColor: 'rgba(243,146,0,0.2)' }}
                  >
                    <div className="text-2xl font-light mb-1" style={{ fontFamily: '"Cormorant Garamond", serif', color: '#2E5984' }}>
                      {stat.number}
                    </div>
        ...
        <motion.div
          ...
          style={{ background: 'linear-gradient(135deg, #0D0D0D 0%, #141414 100%)', border: '0.5px solid rgba(243,146,0,0.2)' }}
        >
