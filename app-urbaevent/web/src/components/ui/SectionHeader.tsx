...
export function SectionHeader({
  badge,
  badgeClass = 'bg-sib-orange/10 text-sib-navy border-sib-orange/30',
  title,
  subtitle,
  align = 'left',
  accentClass = 'from-sib-orange to-sib-orange/70',
  label,
  labelClass = 'text-sib-orange',
}: SectionHeaderProps) {
  return (
    <motion.div
    ...
    >
      {align === 'left' ? (
        ...
        <>
          ...
          <h2 className="sib-v4-section-title mb-4">{title}</h2>
          {subtitle && (
            <p className="text-lg text-sib-ink/70 max-w-3xl mx-auto">{subtitle}</p>
          )}
        </>
      )}
    </motion.div>
