...
const pavilions: Pavilion[] = [
  {
    ...
    targetAudience: ['Autorités du Bâtiment', 'Promoteurs immobiliers', 'Développeurs de solutions BTP'],
    exhibitors: 8,
    visitors: 450,
    conferences: 3,
    demoPrograms: [
      ...
      },
      {
        ...
        company: 'FlowBuild Technologies',
        type: 'presentation',
        capacity: 80,
        registered: 65,
  ...
  },
  {
    ...
    description: "Initiatives environnementales pour des bâtiments durables",
    icon: Globe,
    ...
    demoPrograms: [
      {
        ...
        description: 'Présentation technologique complète des solutions d\'électrification des chantiers au quai avec démonstration de bornes de recharge haute puissance.',
        date: '2026-02-06',
        time: '09:30',
        duration: '75 min',
        speaker: 'Dr. Thomas Green',
        company: 'EcoBuild Energy',
        type: 'demo',
        capacity: 40,
        registered: 28,
        location: 'Zone Extérieure A',
        tags: ['Électrification', 'Énergie', 'chantiers']
      },
      {
        id: 'sustain-2',
        title: 'Workshop Économie Circulaire',
        description: 'Session interactive sur les stratégies d\'économie circulaire appliquées aux bâtiments avec études de cas et démonstrations pratiques.',
        date: '2026-02-06',
        time: '15:00',
        duration: '120 min',
        speaker: 'Isabella Rodriguez',
        company: 'Circular Bâtiments Initiative',
        type: 'workshop',
        capacity: 30,
        registered: 22,
  ...
  },
  {
    ...
    description: "Solutions pour la sécurité physique et numérique des bâtiments",
    icon: Users,
    color: 'text-red-600',
    bgColor: 'bg-red-100',
    ...
    demoPrograms: [
      {
        ...
        time: '12:00',
        duration: '30 min',
        speaker: 'Équipe DroneBTP',
        company: 'DroneBTP Startup',
        type: 'presentation',
        capacity: 100,
        registered: 85,
      ...
      },
      {
        ...
        company: 'ChainBuild Technologies',
        type: 'workshop',
        capacity: 40,
        registered: 31,
