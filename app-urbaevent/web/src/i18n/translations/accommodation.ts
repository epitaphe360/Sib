...
export const accommodationTranslations = {
  ...
  ar: {
    ...
    'accommodation.subtitle': 'استمتع بأسعار تفضيلية تفاوضنا عليها حصرياً لمشاركي SIB',
    'accommodation.badge': 'الفنادق الشريكة',
    'accommodation.hotels_partners': 'الفنادق الشريكة',
    'accommodation.vip_discount': 'خصم VIP',
    'accommodation.april_dates': 'أبريل 2026',
    'accommodation.vip_advantage_title': 'مزايا VIP والبريميوم',
    'accommodation.vip_advantage_desc': 'بالحجز عبر منصتنا برمزك الفريد، تستفيد من:',
    'accommodation.vip_benefit_1': 'أسعار مخفضة تصل إلى -20% من السعر العام',
    'accommodation.vip_benefit_2': 'ترقية حسب الإتاحة',
    'accommodation.vip_benefit_3': 'مكوك مجاني إلى مكان المعرض',
    ...
    'accommodation.contact_hotel': 'التواصل مع الفندق',
    ...
    'accommodation.amenity_wifi': 'واي فاي عالي السرعة',
    'accommodation.amenity_parking': 'موقف سيارات مجاني',
    'accommodation.amenity_pool': 'مسبح',
    'accommodation.amenity_spa': 'سبا وعناية',
    'accommodation.amenity_restaurant': 'مطعم',
    'accommodation.amenity_gym': 'صالة رياضية',
    'accommodation.amenity_casino': 'كازينو',
    'accommodation.amenity_beach': 'وصول للشاطئ',
    'accommodation.amenity_golf': 'غولف',
    'accommodation.amenity_bar': 'بار / لاونج',
    'accommodation.amenity_terrace': 'تراس',
    'accommodation.hotel.pullman.desc': 'مجمع فاخر مع ملعب غولف 18 حفرة وسبا فاخر ووصول مباشر للشاطئ',
    'accommodation.hotel.ibis.desc': 'فندق عصري ومريح بقيمة ممتازة',
    'accommodation.hotel.mazagan.desc': 'منتجع 5 نجوم مع كازينو وشاطئ خاص ومطاعم راقية متعددة',
    'accommodation.hotel.royal.desc': 'فندق أنيق يقع على ملعب غولف مع إطلالات بانورامية',
    'accommodation.hotel.suisse.desc': 'فندق عائلي بخدمة شخصية في قلب مدينة الجديدة',
    'accommodation.hotel.provence.desc': 'سحر البحر الأبيض المتوسط مع تراس بانورامي',
    'accommodation.dist.5km': '5 كم من المعرض',
    'accommodation.dist.3km': '3 كم من المعرض',
    'accommodation.dist.6km': '6 كم من المعرض',
    'accommodation.dist.4km': '4 كم من المعرض',
    'accommodation.dist.2km': '2 كم من المعرض',
    'accommodation.dist.2.5km': '2.5 كم من المعرض',
    'accommodation.room.deluxe_single': 'غرفة ديلوكس مفردة',
    'accommodation.room.deluxe_double': 'غرفة ديلوكس مزدوجة',
    'accommodation.room.suite_junior_single': 'جناح جونيور مفرد',
    'accommodation.room.suite_junior_double': 'جناح جونيور مزدوج',
    'accommodation.room.garden_pool_single': 'غرفة بإطلالة الحديقة والمسبح (مفردة)',
    'accommodation.room.garden_pool_double': 'غرفة بإطلالة الحديقة والمسبح (مزدوجة)',
    'accommodation.room.suite_partial_ocean': 'جناح بإطلالة جزئية على المحيط',
    'accommodation.room.suite_full_ocean': 'جناح بإطلالة كاملة على المحيط',
  },
};