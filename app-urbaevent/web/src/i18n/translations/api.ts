...
export const apiTranslations = {
  ...
  ar: {
    'api.title': 'واجهة برمجة SIB',
    'api.subtitle': 'ادمج بيانات SIB 2026 في تطبيقاتك',
    'api.description': 'واجهة برمجية RESTful كاملة للوصول إلى العارضين والفعاليات والوسائط والمزيد.',
    'api.nav.overview': 'نظرة عامة',
    'api.nav.authentication': 'المصادقة',
    'api.nav.endpoints': 'نقاط النهاية',
    'api.nav.examples': 'الأمثلة',
    'api.nav.rate_limits': 'حدود الطلبات',
    'api.nav.support': 'الدعم',
    'api.overview.title': 'نظرة عامة',
    'api.overview.description': 'توفر واجهة SIB البرمجية وصولاً برمجياً إلى بيانات المعرض.',
    'api.overview.base_url': 'عنوان URL الأساسي',
    'api.overview.version': 'الإصدار',
    'api.overview.format': 'التنسيق',
    'api.features.title': 'الميزات',
    'api.features.restful': 'واجهة RESTful',
    'api.features.restful_desc': 'بنية REST قياسية مع أساليب HTTP',
    'api.features.realtime': 'في الوقت الفعلي',
    'api.features.realtime_desc': 'WebSocket للتحديثات الفورية',
    'api.features.secure': 'آمن',
    'api.features.secure_desc': 'مصادقة JWT وHTTPS إلزامي',
    'api.features.documented': 'موثّق',
    'api.features.documented_desc': 'توثيق كامل مع أمثلة',
    'api.auth.title': 'المصادقة',
    'api.auth.description': 'تستخدم الواجهة رموز JWT للمصادقة.',
    'api.auth.get_token': 'الحصول على رمز',
    'api.auth.use_token': 'استخدام الرمز',
    'api.auth.header': 'رأس التفويض',
    'api.auth.expires': 'الانتهاء',
    'api.auth.refresh': 'تحديث الرمز',
    'api.endpoints.title': 'نقاط النهاية',
    'api.endpoints.exhibitors': 'العارضون',
    'api.endpoints.exhibitors_desc': 'قائمة وتفاصيل العارضين',
    'api.endpoints.events': 'الفعاليات',
    'api.endpoints.events_desc': 'المؤتمرات وورش العمل والبرامج',
    'api.endpoints.partners': 'الشركاء',
    'api.endpoints.partners_desc': 'المنظمات الشريكة',
    'api.endpoints.media': 'الوسائط',
    'api.endpoints.media_desc': 'الويبينارات والبودكاست والفيديوهات',
    'api.endpoints.appointments': 'المواعيد',
    'api.endpoints.appointments_desc': 'إدارة المواعيد',
    'api.methods.get': 'GET - استرداد البيانات',
    'api.methods.post': 'POST - إنشاء مورد',
    'api.methods.put': 'PUT - تحديث مورد',
    'api.methods.delete': 'DELETE - حذف مورد',
    'api.params.query': 'معاملات الاستعلام',
    'api.params.page': 'الصفحة',
    'api.params.limit': 'الحد',
    'api.params.search': 'البحث',
    'api.params.filter': 'التصفية',
    'api.params.sort': 'الترتيب',
    'api.responses.title': 'الاستجابات',
    'api.responses.success': 'نجاح (200-299)',
    'api.responses.error': 'خطأ (400-599)',
    'api.responses.format': 'تنسيق الاستجابة',
    'api.limits.title': 'حدود الطلبات',
    'api.limits.description': 'يحمي الواجهة من الإساءة',
    'api.limits.requests': 'طلب في الساعة',
    'api.limits.exceeded': 'عند تجاوز الحد',
    'api.limits.headers': 'رؤوس الحد',
    'api.examples.title': 'أمثلة الكود',
    'api.examples.javascript': 'JavaScript',
    'api.examples.python': 'Python',
    'api.examples.curl': 'cURL',
    'api.support.title': 'الدعم',
    'api.support.documentation': 'توثيق كامل',
    'api.support.contact': 'تواصل معنا',
    'api.support.status': 'حالة الخدمة',
  },
};
