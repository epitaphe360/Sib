...
import { Crown, Ticket, CheckCircle, ArrowRight, Anchor, X } from 'lucide-react';
              ...
              <div className="p-8">
                ...
                <div className="mt-4 p-3 bg-green-50 rounded-lg border border-green-200">
                  <p className="text-xs text-green-800 inline-flex items-center gap-1">
                    ...
                    Inscription gratuite • Badge disponible dans votre espace
                  </p>
                </div>
              </div>
            </Card>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center"><CheckCircle className="inline h-5 w-5 text-green-600" aria-label="Inclus" /></td>
                    <td className="px-6 py-4 text-center"><CheckCircle className="inline h-5 w-5 text-green-600" aria-label="Inclus" /></td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center text-sm">
                      <span className="inline-flex items-center justify-center gap-1">
                        <CheckCircle className="h-4 w-4 text-green-600" aria-hidden /> Simple
                      </span>
                    </td>
                    <td className="px-6 py-4 text-center text-sm">
                      <span className="inline-flex items-center justify-center gap-1">
                        <CheckCircle className="h-4 w-4 text-green-600" aria-hidden /> Avec photo
                      </span>
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                  ...
                  <tr className="hover:bg-gray-50 bg-yellow-50">
                    ...
                    <td className="px-6 py-4 text-center text-gray-400 text-sm">0</td>
                    <td className="px-6 py-4 text-center text-yellow-700 font-bold text-sm">
                      <span className="inline-flex items-center justify-center gap-1">
                        <CheckCircle className="h-4 w-4" aria-hidden /> {t('common.unlimited')}
                      </span>
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 text-sm text-gray-900">{t('common.dashboard')}</td>
                    <td className="px-6 py-4 text-center text-gray-400"><X className="inline h-5 w-5" aria-label="Non inclus" /></td>
                    <td className="px-6 py-4 text-center"><CheckCircle className="inline h-5 w-5 text-green-600" aria-label="Inclus" /></td>
                  </tr>
                  <tr className="hover:bg-gray-50">
