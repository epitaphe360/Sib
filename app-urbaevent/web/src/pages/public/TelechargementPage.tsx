...
import { ScrollReveal, fadeUp, fadeLeft } from '../../components/ui/motion';
...
export default function TelechargementPage() {
  ...
  return (
    <PublicPageLayout>
      <SibPublicHero
        align="center"
        title={cms.hero_title || 'Téléchargements'}
        subtitle={cms.hero_subtitle || 'Retrouvez les brochures, bilans et dossiers de presse des différentes éditions du SIB.'}
      />
