        ...
        {loading ? (
          ...
          <>
            ...
            {isExhibitor ? (
              ...
              <Text style={styles.exhibitorHint}>{t('badge.a4AdminHint')}</Text>
            )}

            {showA4 ? (
              <View style={styles.a4Wrap}>
                <Text style={styles.a4Label}>{t('badge.bifoldPreview')}</Text>
                <BadgeA4Bifold badge={badge} qrValue={displayQr} />
              </View>
            ) : null}

            <View ref={printRef} collapsable={false} style={styles.hiddenPrintPreview} pointerEvents="none">
              <BadgeA4Bifold badge={badge} previewScale={false} qrValue={displayQr} printMode />
            </View>
            ...
            <View style={styles.secondaryGrid}>
              {[
                ...
                { label: t('badge.downloadPdf'), icon: 'download-outline' as const, onPress: () => runPrintAction(shareBadgePdfFromView) },
                ...(!isExhibitor
                  ? [
