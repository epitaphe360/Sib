...
import { SalonActiveBar } from '../../../src/components/home/SalonActiveBar';
import { SalonGate } from '../../../src/components/guards/SalonGate';
import { Chip, IllustratedEmpty, PrimaryButton, Screen, SecondaryButton, SegmentControl } from '../../../src/components/ui';
    ...
    <Screen style={styles.flex}>
      ...
      <View style={styles.mapBtn}>
        <SecondaryButton
          label={t('map.title')}
          icon="map-outline"
          onPress={() => router.push('/(visitor)/map' as never)}
        />
      </View>
...
const styles = StyleSheet.create({
  ...
  mapBtn: { marginBottom: spacing.md },
  search: {
