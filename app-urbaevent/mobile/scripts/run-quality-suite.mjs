...
const steps = [
  ...
  },
  {
    ...
    cwd: monorepoRoot,
    cmd: 'npx',
    args: ['vitest', 'run', 'app-urbaevent/tests/unit/mobile', '--reporter=verbose'],
  },
  {
    id: 'coverage',
    ...
    cwd: monorepoRoot,
    cmd: 'npx',
    args: ['vitest', 'run', 'app-urbaevent/tests/unit/mobile', '--config', 'vitest.mobile.config.ts', '--coverage'],
  },
  {
    id: 'brand',
