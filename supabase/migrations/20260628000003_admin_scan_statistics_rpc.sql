-- Statistiques scans admin (entrées, réseautage, stands, contrôleurs)
...
COMMENT ON FUNCTION public.get_admin_scan_statistics IS
  'Comptages scans salon pour dashboard admin mobile — COUNT(DISTINCT) côté PostgreSQL, adapté 200k+ visiteurs';
