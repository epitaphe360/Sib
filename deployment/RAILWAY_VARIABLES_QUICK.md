...
```bash
VITE_APP_URL=https://SIB 2026-production.up.railway.app
NODE_ENV=production
```
...
- [ ] Rafraîchir la page : https://SIB 2026-production.up.railway.app
...
Rafraîchir : https://SIB 2026-production.up.railway.app
...
1. Vérifier les URLs autorisées dans Supabase :
   ...
   - Ajouter : `https://SIB 2026-production.up.railway.app`
