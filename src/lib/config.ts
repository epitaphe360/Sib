...
export const CONFIG = {
  ...
  emails: {
    support: {
      technical: 'support@sib2026.ma',
      commercial: 'commercial@sib2026.ma',
      exhibitor: 'exhibitor@sib2026.ma',
      general: 'support@sib2026.ma',
      api: 'api@sib2026.ma',
      emergency: 'urgence@sib2026.ma'
    }
  },
  ...
  urls: {
    api: {
      base: 'https://api.SIB2026.com',
      docs: '/docs/api',
      auth: '/auth'
    },
    external: {
      docs: 'https://docs.SIB2026.com'
    }
  },
