...
const salonEvents: EventAccess[] = [
  {
    ...
    eventName: 'Cérémonie d\'ouverture SIB 2026',
    eventType: 'public',
    requiredLevel: 'basic',
  ...
  },
  {
    ...
    eventType: 'vip',
    requiredLevel: 'vip',
    description: 'Petit-déjeuner exclusif avec les dirigeants du secteur du bâtiment et de la construction.',
  ...
  {
    eventId: 'gala-dinner',
    eventName: 'Dîner de Gala SIB 2026',
    eventType: 'gala',
    requiredLevel: 'vip',
    description: 'Soirée de prestige avec remise des prix de l\'innovation bâtiment.',
