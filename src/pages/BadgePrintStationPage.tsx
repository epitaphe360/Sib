      ...
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-600 to-indigo-600 flex items-center justify-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-4 text-sm">
              ...
              <div className="text-center">
                <div className="font-bold text-indigo-600">{stats.totalPrinted}</div>
                  ...
                  <Card>
                    ...
                    <div className="p-4 grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-4 text-center">
                        <div className="text-3xl font-bold text-indigo-700">{stats.totalPrinted}</div>
                        <div className="text-sm text-indigo-600 mt-1">Total imprimé</div>
                      </div>
