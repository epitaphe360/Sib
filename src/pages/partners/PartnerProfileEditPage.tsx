      ...
      if (user?.id) {
        ...
        await SupabaseService.updateUser(user.id, {
          ...
          profile: {
            ...
            sectors: completeFormData.sectors,

            services: completeFormData.services,

            expertise: completeFormData.expertise,

            projects: completeFormData.projects,

            team: completeFormData.team,

            metrics: completeFormData.metrics,

            timeline: completeFormData.timeline,
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">{t('partner_edit.profil_sponsor', 'Profil Sponsor')}</h1>

              <p className="text-gray-600 mt-2">{t('partner_edit.completez_votre_profil_progressivement_s', 'Complétez votre profil progressivement - seul le nom est obligatoire')}</p>

            </div>

            <div className="text-right">

              <div className="text-sm text-gray-600 mb-1">{t('partner_edit.completude', 'Complétude')}</div>
        ...
        <div className="space-y-4">
              ...
              <div className="p-6 border-t">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.type_dorganisation', 'Type d\'organisation')}</label>

                    <select value={formData.type} onChange={(e) => handleInputChange('type', e.target.value)}

                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">

                      <option value="corporate">{t('partner_edit.entreprise', 'Entreprise')}</option>

                      <option value="sponsor">{t('partner_edit.sponsor', 'Sponsor')}</option>

                      <option value="organizer">{t('partner_edit.organisateur', 'Organisateur')}</option>

                      <option value="association">{t('partner_edit.association', 'Association')}</option>

                      <option value="government">{t('partner_edit.organisation_gouvernementale', 'Organisation gouvernementale')}</option>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.description', 'Description')}</label>
                ...
                <div className="mt-6 pt-6 border-t">
                  ...
                  <label className="block text-sm font-medium text-gray-700 mb-3">{t('partner_edit.logo', 'Logo')}</label>
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-500">{t('partner_edit.png_jpg_jusqua_2mb', 'PNG, JPG jusqu\'à 2MB')}</p>
              ...
              <div className="p-6 border-t">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.adresse_complete', 'Adresse complète')}</label>
              ...
              <div className="p-6 border-t">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.employes', 'Employés')}</label>
                  ...
                  <div>
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.annee_de_creation', 'Année de création')}</label>
                  ...
                  <div>
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.directeur_general', 'Directeur Général')}</label>
              ...
              <div className="p-6 border-t">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-3">{t('partner_edit.secteurs_dactivite', 'Secteurs d\'activité')}</label>
                  ...
                  <div>
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.certifications', 'Certifications')}</label>
          ...
          <Card>
            ...
            {expandedSections.gallery && (
              ...
              <div className="p-6 border-t">
                  ...
                  {formData.gallery.map((img, i) => (
                    ...
                    <div key={i} className="relative group">
                      ...
                      <button onClick={() => setFormData(prev => ({ ...prev, gallery: prev.gallery.filter((_, idx) => idx !== i) }))}
                        ...
                        className="absolute top-2 right-2 bg-red-600 text-white p-2 min-w-[36px] min-h-[36px] flex items-center justify-center rounded-full opacity-0 group-hover:opacity-100 transition">
                ...
                <p className="mt-2 text-sm text-gray-500">{t('partner_edit.ajoutez_plusieurs_images_de_votre_entrep', 'Ajoutez plusieurs images de votre entreprise, installations, projets...')}</p>
              ...
              <div className="p-6 border-t">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.projets_realises', 'Projets réalisés')}</label>
                  ...
                  <div>
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.annees_dexperience', 'Années d\'expérience')}</label>
                  ...
                  <div>
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.taille_de_lequipe', 'Taille de l\'équipe')}</label>
                  ...
                  <div>
                    ...
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('partner_edit.pays_desservis', 'Pays desservis')}</label>
          ...
          <div className="flex justify-between items-center pt-6">
            ...
            <Link to={ROUTES.PARTNER_DASHBOARD}>

              <Button variant="outline">{t('partner_edit.annuler', 'Annuler')}</Button>
            ...
            <Button onClick={handleSave} disabled={isSaving}>
              ...
              {isSaving ? (
                ...
                <><div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2" />{t('partner_edit.sauvegarde', 'Sauvegarde...')}</>

              ) : (

                <><Save className="h-4 w-4 mr-2" />{t('partner_edit.sauvegarder', 'Sauvegarder')}</>
