        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
          ...
          >
            <h1 className="text-3xl font-bold text-gray-900 mb-4">
              Actualités Portuaires SIB
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Restez informé des dernières nouvelles du secteur portuaire et des actualités SIB 2026
            </p>
          </motion.div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="text-center p-6">
              ...
              <div className="text-sm text-gray-600">{t('admin.total_articles')}</div>
            </Card>
            ...
            <Card className="text-center p-6">
              ...
              <div className="text-sm text-gray-600">{t('common.total')} {t('common.views')}</div>
            </Card>
