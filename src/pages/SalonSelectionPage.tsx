      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0D2137] via-[#1B4F72] to-[#2E7DB8] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          ...
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-base sm:text-xl text-indigo-200 max-w-2xl mx-auto leading-relaxed px-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 max-w-3xl mx-auto">
            {PLATFORM_STATS.map((s) => (
              ...
              >
                ...
                <div className="text-xs sm:text-sm text-indigo-300 font-medium mt-0.5">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
