...
export default function FemmesHommesPage() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Montserrat', ui-sans-serif, system-ui, sans-serif" }}>
      ...
      <section className="relative min-h-[80vh] flex items-end overflow-hidden">
        ...
        />
        {/* Gradients */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#07182C] via-[#07182C]/75 to-[#07182C]/20" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#07182C]/90 via-[#07182C]/40 to-transparent" />

        {/* Accent line */}
        <div className="absolute top-0 inset-x-0 h-1 bg-[#F39200]" />

        {/* Portrait collage — right side */}
        <div className="absolute right-0 top-0 bottom-0 w-1/3 hidden lg:flex">
          {dynamicPortraits.map((src) => (
            <div key={src} className="relative flex-1 overflow-hidden border-l border-white/10 first:border-l-0">
              <img
                src={src}
                alt=""
          ...
          {/* Left fade over portraits */}
          <div className="absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-[#07182C] to-transparent" />
        </div>

        {/* Content */}
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pb-20 pt-8 w-full">
          <motion.div
          ...
          >
            {/* Kicker */}
            <p className="text-[#F39200] text-[10px] font-bold uppercase tracking-[0.28em] mb-6 flex items-center gap-3">
              <span className="inline-block w-6 h-px bg-[#F39200]" />
              Salon International du Bâtiment · SIB 2026
            </p>

            {/* Title */}
            <h1 className="text-white font-extrabold uppercase leading-[1.05] tracking-tight mb-6"
              style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              Les Femmes<br />et les Hommes<br />
              <span style={{ color: '#F39200' }}>qui Construisent<br />le Maroc</span>
            </h1>

            {/* Tagline */}
            <p className="text-white/70 text-base leading-relaxed mb-10 max-w-md">
              Le SIB valorise les métiers, les compétences et les expertises qui bâtissent aujourd'hui le Maroc de demain.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 px-8 py-4 text-xs font-bold uppercase tracking-widest text-[#07182C] hover:brightness-90 transition-all"
