          ...
          <Card className="p-6 bg-indigo-50 border-indigo-100">
            ...
            <ol className="space-y-3 text-indigo-800 text-sm">
              ...
              <li className="flex gap-2">
                ...
                <span dangerouslySetInnerHTML={{ __html: sanitizeHtml(t('payment.instructions.step1', { amount: amount.toFixed(2) })) }} />
              ...
              <li className="flex gap-2">
                ...
                <span dangerouslySetInnerHTML={{ __html: sanitizeHtml(t('payment.instructions.step2', { reference: referenceCode })) }} />
