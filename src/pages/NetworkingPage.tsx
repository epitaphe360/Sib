    ...
    return (
      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <PageHero
          ...
          badge={<><Sparkles className="w-4 h-4 text-yellow-300" /><span className="text-sm font-semibold text-yellow-300 uppercase tracking-wider">{t('networking.propulse_par_lia_sib', 'Propulsé par l\'IA SIB')}</span></>}

          title={<>{t('networking.reseautage', 'Réseautage')}<span className="text-yellow-300">{t('networking.intelligent', 'Intelligent')}</span></>}
        ...
        <div className="bg-white border-t border-gray-200 py-20 px-4">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <h3 className="text-3xl font-bold text-gray-800 mb-12 text-center">{t('networking.lecosysteme_sib_a_votre_service', 'L\'écosystème SIB à votre service')}</h3>
        ...
        <footer className="bg-gray-50 text-gray-400 py-12 border-t border-gray-200 text-center text-sm">
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="flex justify-center gap-8 mb-6">
              ...
              <a href="https://sibevent.com/conditions-generales-2/" className="hover:text-indigo-600 transition-colors">{t('networking.conditions_generales', 'Conditions Générales')}</a>

              <a href="https://sibevent.com/politique-de-confidentialite/" className="hover:text-indigo-600 transition-colors">{t('networking.confidentialite', 'Confidentialité')}</a>

              <a href="https://sibevent.com/mentions-legales/" className="hover:text-indigo-600 transition-colors">{t('networking.mentions_legales', 'Mentions Légales')}</a>

            </div>

            <div className="inline-block px-4 py-1 rounded-full bg-gray-100 border border-gray-200">

              Contact : <a href="mailto:Sib2026@urbacom.net" className="text-indigo-600 hover:underline">{t('networking.sib2026urbacomnet', 'Sib2026@urbacom.net')}</a>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100">
                ...
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div>
                    ...
                    <h2 className="text-2xl font-black text-slate-900">{t('networking.votre_activite', 'Votre Activité')}</h2>

                    <p className="text-slate-500">{t('networking.apercu_de_vos_interactions_recentes', 'Aperçu de vos interactions récentes')}</p>
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-indigo-50 to-indigo-50 rounded-2xl border border-indigo-100">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-bold text-slate-900 text-sm">{t('networking.quotas_quotidiens', 'Quotas Quotidiens')}</h3>
                  ...
                  <div className="mt-6 p-4 bg-gradient-to-r from-amber-50 to-indigo-50 rounded-2xl border border-amber-200">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      ...
                      <div>
                        ...
                        <h3 className="font-bold text-slate-900 text-sm">{t('networking.matching_avance_non_genere', 'Matching avancé non généré')}</h3>

                        <p className="text-xs text-slate-600">{t('networking.cliquez_pour_lancer_lanalyse_ia_et_affic', 'Cliquez pour lancer l\'analyse IA et afficher vos recommandations.')}</p>
              ...
              <div className="bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-3xl shadow-xl p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold mb-2">{t('networking.networking_score', 'Networking Score')}</h3>

                  <p className="text-indigo-100/70 text-sm mb-6">{t('networking.votre_influence_sur_le_salon', 'Votre influence sur le salon')}</p>
                  ...
                  <div className="flex items-center justify-center mb-6">
                    ...
                    <div className="relative w-32 h-32">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        <span className="text-[10px] font-bold uppercase opacity-60">{t('networking.points', 'Points')}</span>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="opacity-70">{t('networking.profil_complete', 'Profil complété')}</span>
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="opacity-70">{t('networking.engagement', 'Engagement')}</span>
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col justify-center items-center py-20">
                ...
                <span className="mt-6 text-slate-500 font-medium animate-pulse">{t('networking.analyse_de_votre_profil_par_lia', 'Analyse de votre profil par l\'IA...')}</span>
              ...
              <Card className="p-12 text-center border-rose-100 bg-rose-50/50 rounded-3xl">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">{t('networking.oups_quelque_chose_sest_mal_passe', 'Oups ! Quelque chose s\'est mal passé')}</h3>
              ...
              <Card className="text-center p-6 sm:p-10 md:p-16 bg-white rounded-3xl shadow-xl border-slate-100">
                ...
                <h3 className="text-3xl font-black text-slate-900 mb-4">{t('networking.activez_votre_reseau_ia', 'Activez votre Réseau IA')}</h3>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-200 rounded-2xl p-6 mb-8 max-w-md mx-auto">
                  ...
                  <div className="flex items-center justify-center gap-2 mb-3">
                    ...
                    <span className="font-bold text-purple-900">{t('networking.ameliorez_votre_matching', 'Améliorez votre matching')}</span>
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500">{t('networking.base_sur_votre_profil_et_vos_interets', 'Basé sur votre profil et vos intérêts')}</p>
                            ...
                            <div className="mb-6">
                              ...
                              <div className="text-sm text-slate-500 line-clamp-3 leading-relaxed">
                                ...
                                {profile.profile?.bio || profile.profile?.companyDescription ? (
                                  ...
                                  <span className="italic opacity-60">{t('networking.aucune_description_renseignee_pour_cette', 'Aucune description renseignée pour cette entreprise.')}</span>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-12">
            ...
            <div className="bg-white rounded-[3rem] p-10 shadow-xl border border-slate-100 relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="text-center md:text-left">
                  ...
                  <h2 className="text-4xl font-black text-slate-900 mb-2">{t('networking.explorateur_de_reseau', 'Explorateur de Réseau')}</h2>

                  <p className="text-slate-500 text-lg">{t('networking.trouvez_les_partenaires_strategiques_par', 'Trouvez les partenaires stratégiques parmi des milliers de profils vérifiés.')}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <option value="">{t('networking.tous_les_secteurs', 'Tous les secteurs')}</option>

                    <option value="bâtiment">{t('networking.batiment', 'Bâtiment')}</option>

                    <option value="logistique">{t('networking.logistique', 'Logistique')}</option>

                    <option value="transport">{t('networking.transport', 'Transport')}</option>

                    <option value="technologie">{t('networking.technologie', 'Technologie')}</option>

                    <option value="finance">{t('networking.finance', 'Finance')}</option>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <option value="">{t('networking.toutes_entreprises', 'Toutes entreprises')}</option>

                    <option value="exhibitor">{t('networking.exposant', 'Exposant')}</option>

                    <option value="partner">{t('networking.partenaire', 'Partenaire')}</option>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <option value="">{t('networking.toutes_regions', 'Toutes régions')}</option>

                    <option value="europe">{t('networking.europe', 'Europe')}</option>

                    <option value="afrique">{t('networking.afrique', 'Afrique')}</option>

                    <option value="asie">{t('networking.asie', 'Asie')}</option>

                    <option value="amerique">{t('networking.amerique', 'Amérique')}</option>
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-xs text-slate-500 line-clamp-2 leading-relaxed">
                                ...
                                {profile.profile?.bio || profile.profile?.companyDescription ? (
                                  ...
                                  <span className="italic opacity-60">{t('networking.aucune_description_renseignee', 'Aucune description renseignée.')}</span>
            ...
            {searchTerm && searchResults.length === 0 && (
              ...
              <Card className="text-center p-20 bg-white rounded-[3rem] shadow-xl border-slate-100">
                ...
                <h3 className="text-2xl font-black text-slate-900 mb-4">{t('networking.aucun_resultat_trouve', 'Aucun résultat trouvé')}</h3>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-12">
            ...
            <div className="bg-white rounded-[3rem] p-10 shadow-xl border border-slate-100 relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="text-center md:text-left">
                  ...
                  <h2 className="text-4xl font-black text-slate-900 mb-2">{t('networking.mon_reseau_business', 'Mon Réseau Business')}</h2>

                  <p className="text-slate-500 text-lg">{t('networking.gerez_vos_relations_et_transformez_vos_c', 'Gérez vos relations et transformez vos contacts en opportunités.')}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 flex items-center space-x-6">
                ...
                <div>
                  ...
                  <div className="text-xs font-black text-slate-400 uppercase tracking-widest">{t('networking.actifs', 'Actifs')}</div>
              ...
              <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 flex items-center space-x-6">
                ...
                <div>
                  ...
                  <div className="text-xs font-black text-slate-400 uppercase tracking-widest">{t('networking.en_attente', 'En attente')}</div>
              ...
              <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 flex items-center space-x-6">
                ...
                <div>
                  ...
                  <div className="text-xs font-black text-slate-400 uppercase tracking-widest">{t('networking.favoris', 'Favoris')}</div>
            ...
            {connections.length === 0 ? (
              ...
              <Card className="text-center p-20 bg-white rounded-[3rem] shadow-xl border-slate-100">
                ...
                <h3 className="text-2xl font-black text-slate-900 mb-4">{t('networking.votre_reseau_est_encore_vide', 'Votre réseau est encore vide')}</h3>
                        ...
                        <Card key={connectionId} className="p-6 bg-white border-slate-100 rounded-[2rem] opacity-50">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-slate-400">{t('networking.chargement', 'Chargement...')}</p>
              ...
              <div className="relative z-20 flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="inline-flex items-center space-x-2 bg-indigo-500/20 border border-indigo-500/30 rounded-full px-4 py-2 mb-6">
                    ...
                    <span className="text-indigo-300 text-xs font-black uppercase tracking-widest">{t('networking.analyse_predictive', 'Analyse Prédictive')}</span>
                  ...
                  <h2 className="text-4xl md:text-6xl font-black text-white mb-6 leading-tight">
                    ...
                    <span className="text-indigo-400">{t('networking.strategiques', 'Stratégiques')}</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <Card className="lg:col-span-2 p-8 bg-white rounded-[2.5rem] shadow-xl border-slate-100">
                    ...
                    <div className="flex items-center justify-between mb-8">
                      ...
                      <div>
                        ...
                        <h3 className="text-xl font-black text-slate-900">{t('networking.ecosysteme_de_reseau', 'Écosystème de Réseau')}</h3>

                        <p className="text-slate-500 text-sm">{t('networking.repartition_par_secteurs_dactivite', 'Répartition par secteurs d\'activité')}</p>
                  ...
                  <div className="space-y-8">
                    ...
                    <Card className="p-8 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-[2.5rem] shadow-xl text-white">
                      ...
                      <h3 className="text-lg font-bold mb-6">{t('networking.qualite_des_matches', 'Qualité des Matches')}</h3>

                      <div className="flex items-end justify-between mb-4">

                        <div className="text-3xl sm:text-4xl md:text-5xl font-black">88%</div>

                        <div className="bg-white/20 px-3 py-1 rounded-full text-xs font-bold">{t('networking.top_5', 'TOP 5%')}</div>
                    ...
                    <Card className="p-8 bg-white rounded-[2.5rem] shadow-xl border-slate-100">
                      ...
                      <h3 className="text-slate-900 font-black mb-6">{t('networking.croissance', 'Croissance')}</h3>
                      ...
                      <div className="flex items-center justify-between mt-4">
                        ...
                        <span className="text-slate-400 text-xs font-bold uppercase">{t('networking.activite_hebdo', 'Activité Hebdo')}</span>
                  ...
                  <div className="flex flex-col md:flex-row gap-10">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-3 mb-6">
                        ...
                        <h3 className="text-2xl font-black text-slate-900">{t('networking.synthese_de_lia', 'Synthèse de l\'IA')}</h3>
                        ...
                        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                          ...
                          <ul className="space-y-3">
                            ...
                            {aiInsights.suggestions.length === 0 && (
                              ...
                              <li className="text-sm text-slate-400 italic">{t('networking.aucune_recommandation_pour_le_moment', 'Aucune recommandation pour le moment')}</li>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-12">
            ...
            <div className="bg-white rounded-[3rem] p-10 shadow-xl border border-slate-100 relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="text-center md:text-left">
                  ...
                  <h2 className="text-4xl font-black text-slate-900 mb-2">{t('networking.mes_favoris', 'Mes Favoris')}</h2>

                  <p className="text-slate-500 text-lg">{t('networking.gardez_un_il_sur_les_profils_qui_compten', 'Gardez un œil sur les profils qui comptent le plus pour vous.')}</p>
            ...
            {favorites.length === 0 ? (
              ...
              <Card className="text-center p-20 bg-white rounded-[3rem] shadow-xl border-slate-100">
                ...
                <h3 className="text-2xl font-black text-slate-900 mb-4">{t('networking.aucun_favori_enregistre', 'Aucun favori enregistré')}</h3>
                    ...
                    return (
                      ...
                      <Card key={favoriteId} className="p-8 bg-white border-slate-100 rounded-[2.5rem] opacity-50">
                        ...
                        <div className="text-center text-slate-400">
                          ...
                          <p className="text-sm">{t('networking.chargement', 'Chargement...')}</p>
                ...
                {(() => {
                  ...
                  return (
                    ...
                    <div className="text-center py-12 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
                      ...
                      <p className="text-gray-600 font-medium">{t('networking.aucun_creneau_disponible_pour_le_moment', 'Aucun créneau disponible pour le moment')}</p>

                      <p className="text-sm text-gray-500 mt-1">{t('networking.veuillez_reessayer_plus_tard_ou_contacte', 'Veuillez réessayer plus tard ou contacter l\'exposant')}</p>
