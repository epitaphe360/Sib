...
export default function NetworkingPage() {
  ...
  }, [isAuthenticated, user?.id, hasAutoGenerated, searchParams]);
        ...
        <footer className="bg-[#050c1a] text-white/40 py-12 border-t border-white/5 text-center text-sm">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="flex justify-center gap-8 mb-6">
              <a href="https://sib2026.ma/conditions-generales-2/" className="hover:text-white transition-colors">Conditions Générales</a>
              <a href="https://sib2026.ma/politique-de-confidentialite/" className="hover:text-white transition-colors">Confidentialité©</a>
              <a href="https://sib2026.ma/mentions-legales/" className="hover:text-white transition-colors">Mentions Légales</a>
            </div>
            <div className="inline-block px-4 py-1 rounded-full bg-white/5 border border-white/10">
              Contact : <a href="mailto:contact@sib2026.ma" className="text-blue-400 hover:underline">contact@sib2026.ma</a>
            </div>
          </div>
        </footer>
      </div>
