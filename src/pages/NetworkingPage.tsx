...
import {
  ...
  Target, Sparkles, Shield, ArrowRight, Info, X
} from 'lucide-react';
import {
        ...
        <div className="relative flex-1 flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 tracking-tight leading-none">
              ...
              <p className="text-xl md:text-2xl text-blue-100/80 max-w-3xl mx-auto mb-12 font-light leading-relaxed">
                Connectez-vous avec les leaders de l'industrie du bâtiment mondiale. <br className="hidden md:block" />
              ...
              <div className="max-w-lg mx-auto bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link to={`${ROUTES.LOGIN}?redirect=${encodeURIComponent(ROUTES.NETWORKING)}`} className="flex-1">
                    ...
                    {(() => {
                      ...
                      return [
                        ...
                        <div key={quota.label} className="bg-white rounded-xl p-3 shadow-sm">
                          <quota.icon className="h-4 w-4 text-blue-500 mx-auto mb-1" />
                          <div className="text-lg font-black text-slate-900">
                            {quota.value === 999999 ? '∞' : quota.value}
                          </div>
                        ...
                        <Card className="h-full flex flex-col bg-white hover:shadow-2xl transition-all duration-500 border-slate-100 rounded-[2rem] overflow-hidden relative">
                            ...
                            <div className="mb-6">
                              <div className="flex items-center space-x-2 mb-1">
                                <h4 className="font-black text-xl text-slate-900 group-hover:text-blue-600 transition-colors truncate flex items-center">
                                  ...
                                  {profile.profile?.company || (profile.profile as any)?.companyName || profile.name || 'Compagnie non renseignée'}
                                </h4>
                          ...
                          <div className="p-6 bg-slate-50/50 border-t border-slate-100 flex items-center justify-between gap-3">
                            ...
                            <div className="flex items-center space-x-2">
                              {isConnected ? (
                                <button onClick={() => handleMessage(getDisplayName(profile), profile.profile?.company || (profile.profile as any)?.companyName || '', profile.id, navigate)} className="p-2.5 rounded-xl border bg-indigo-50 border-indigo-200 text-indigo-600 hover:bg-indigo-100 transition-all" title="Envoyer un message">
                              ...
                              <button
                                onClick={() => handleViewProfile(getDisplayName(profile), profile.profile?.company || (profile.profile as any)?.companyName || '', profile)}
                        ...
                        <Card className="p-6 bg-white hover:shadow-2xl transition-all duration-300 border-slate-100 rounded-[2rem] relative group">
                          ...
                          <div className="flex items-center justify-between gap-3">
                            <div className="flex items-center gap-2">
                              {isConnected ? (
                                <button onClick={() => handleMessage(getDisplayName(profile), profile.profile?.company || (profile.profile as any)?.companyName || '', profile.id, navigate)} className="p-2 border bg-indigo-50 border-indigo-200 text-indigo-600 hover:bg-indigo-100 rounded-xl transition-all" title="Envoyer un message">
                                  <MessageCircle className="h-5 w-5" />
                                </button>
                              ) : isPending ? (
