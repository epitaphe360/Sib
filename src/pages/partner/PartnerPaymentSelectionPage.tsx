...
export default function PartnerPaymentSelectionPage() {
  ...
  const handleOnlinePayment = () => {
    ...
    // Paiement en ligne non disponible — rediriger vers le virement bancaire

    toast.info('Le paiement en ligne est temporairement indisponible. Veuillez utiliser le virement bancaire.');
