    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-4 py-5 flex items-center gap-3">
          <Link to={ROUTES.PARTNER_DASHBOARD} className="text-gray-400 hover:text-gray-600 transition-colors">
            <ArrowLeft className="w-5 h-5" />
          </Link>
          <FileText className="w-6 h-6 text-amber-600" />
          <div>
            <h1 className="text-xl font-bold text-gray-900">Mes Factures</h1>
            <p className="text-sm text-gray-500">Historique de vos factures partenaire SIB 2026</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* Info contact admin */}
        <div className="mt-8 bg-amber-50 rounded-2xl border border-amber-100 p-5 text-sm text-amber-700">
