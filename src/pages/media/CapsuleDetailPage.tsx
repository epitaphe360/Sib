...
export const CapsuleDetailPage: React.FC = () => {
  ...
  const loadCapsule = async () => {
    try {
      ...
      toast.error(t('media.error.loading_capsule'));
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSave = () => {
    setIsSaved(!isSaved);
    toast.success(isSaved ? t('media.capsule.removed_from_favorites') : t('media.capsule.added_to_favorites'));
  };
  ...
  const handleShare = () => {
    if (navigator.share) {
      ...
      toast.success(t('media.capsule.link_copied'));
    }
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('media.capsule.not_found')}</h2>
            ...
            <div>
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                >
                  ...
                  {isSaved ? t('media.capsule.saved') : t('media.capsule.save')}
                </Button>
              ...
              <div className="flex items-center space-x-6 text-sm text-gray-600">
                {capsule.views_count && (
                  <div className="flex items-center">
                    ...
                    {capsule.views_count.toLocaleString()} {t('media.detail.views').toLowerCase()}
                  </div>
                )}
                {capsule.duration && (
                  <div className="flex items-center">
