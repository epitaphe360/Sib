...
const STATIC_PAVILIONS: Pavilion[] = [
  ...
  {
    id: '3',
    name: 'Pavillon Équipements Sanitaires',
    slug: 'equipements-sanitaires',
    description: 'Solutions sanitaires, plomberie, robinetterie et équipements de salle de bain.',
    color: '#0891B2',
    icon: 'Droplets',
    order_index: 3,
    featured: true,
  ...
  {
    id: '4',
    name: 'Pavillon Innovation & Durabilité',
    slug: 'innovation-durabilite',
    description: 'Énergies renouvelables, bâtiment vert, solutions smart building et technologies innovantes.',
    color: '#7C3AED',
    icon: 'Lightbulb',
    order_index: 4,
    featured: true,
