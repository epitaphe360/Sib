...
const NewsCard: React.FC<NewsCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-red-600 via-yellow-400 to-green-600 rounded-2xl rotate-1 group-hover:rotate-2 transition-transform" />
      ...
      <div className="relative bg-white rounded-2xl overflow-hidden shadow-lg">
        ...
        <div className="relative h-48 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-indigo-600/90 via-indigo-600/50 to-transparent" />

          {/* Badge catégorie */}
          <span className="absolute top-4 left-4 bg-yellow-400 text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider shadow-lg">
            {category || 'Actualité'}
          </span>
        </div>
        ...
        {/* Contenu */}
        <div className="p-6">
          <h3 className="font-bold text-xl mb-3 text-indigo-600 group-hover:text-yellow-400 transition-colors line-clamp-2">
            {title}
          </h3>
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            <span className="bg-gradient-to-r from-indigo-600 via-yellow-400 to-green-600 bg-clip-text text-transparent">
        ...
        >
          <Link
            to="/news"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-indigo-600 to-sib-accent text-white px-8 py-4 rounded-xl font-bold hover:shadow-lg hover:scale-105 transition-all"
          >
