...
export const FeaturedExhibitors: React.FC = () => {
  ...
  return (
    <section className="py-28 bg-[#F8F9FA] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.025]" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, rgba(243,146,0,1) 1px, transparent 0)', backgroundSize: '28px 28px' }} />
