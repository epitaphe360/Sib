...
export function ServicesSection() {
  ...
  const whatsappNumber = '+212523366816';
  const phoneNumber = '+212523366816';
  const emailAddress = 'contact@sib.ma';
  ...
  return (
    <section className="py-24 px-4 bg-[#F8F9FA] border-t" style={{ borderColor: 'rgba(243,146,0,0.3)' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="luxury-card p-6 flex flex-col">
            <div className="flex items-center justify-center w-12 h-12 rounded-sm mb-4" style={{ background: 'rgba(243,146,0,0.1)', border: '0.5px solid rgba(243,146,0,0.3)' }}>
              <MessageCircle className="h-5 w-5" style={{ color: '#F39200' }} />
            </div>
            ...
            <Button
              ...
              className="w-full bg-[#F39200] hover:bg-[#2E5984] text-[#1A1A1A] font-medium"
            >
          ...
          <div className="luxury-card p-6 flex flex-col">
            <div className="flex items-center justify-center w-12 h-12 rounded-sm mb-4" style={{ background: 'rgba(243,146,0,0.1)', border: '0.5px solid rgba(243,146,0,0.3)' }}>
              <Mail className="h-5 w-5" style={{ color: '#F39200' }} />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              Email
            </h3>
            ...
            <a href={`mailto:${emailAddress}`}>
              <Button className="w-full bg-[#F39200] hover:bg-[#2E5984] text-[#1A1A1A] font-medium">
          ...
          <div className="luxury-card p-6 flex flex-col">
            <div className="flex items-center justify-center w-12 h-12 rounded-sm mb-4" style={{ background: 'rgba(243,146,0,0.1)', border: '0.5px solid rgba(243,146,0,0.3)' }}>
              <Phone className="h-5 w-5" style={{ color: '#F39200' }} />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              {t('services.phone')}
            </h3>
          ...
          <div className="luxury-card p-6 flex flex-col">
            <div className="flex items-center justify-center w-12 h-12 rounded-sm mb-4" style={{ background: 'rgba(243,146,0,0.1)', border: '0.5px solid rgba(243,146,0,0.3)' }}>
              <Clock className="h-5 w-5" style={{ color: '#F39200' }} />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              {t('services.hours')}
            </h3>
        ...
        {/* CTA Banner contact */}
        <div className="rounded-sm p-10 text-white text-center" style={{ background: 'linear-gradient(135deg, #0D0D0D 0%, #141414 100%)', border: '0.5px solid rgba(243,146,0,0.2)' }}>
