    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-white font-bold text-sm tracking-wide">Activité Récente</span>
        </div>
      ...
      <div className="divide-y max-h-[340px] overflow-y-auto" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
        {activities.length === 0 ? (
          <div className="px-6 py-12 text-center">
            ...
            >
              <Activity className="h-10 w-10 mx-auto mb-3" style={{ color: 'rgba(255,255,255,0.12)' }} />
            </motion.div>
            <p className="text-sm" style={{ color: 'rgba(255,255,255,0.3)' }}>Aucune activité récente</p>
          </div>
        ) : (
          <AnimatePresence>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium leading-snug" style={{ color: 'rgba(255,255,255,0.80)' }}>{activity.description}</p>
                    <div className="flex items-center gap-2 mt-1">
                      <Clock className="h-3 w-3" style={{ color: 'rgba(255,255,255,0.25)' }} />
                      <span className="text-xs" style={{ color: 'rgba(255,255,255,0.3)' }}>{formatDate(activity.timestamp)}</span>
                      <span style={{ color: 'rgba(255,255,255,0.12)' }}>·</span>
                      <span className="text-xs" style={{ color: 'rgba(255,255,255,0.35)' }}>{activity.adminUser}</span>
                    </div>
                  </div>
