      ...
      <div className="bg-[#0F2034] px-6 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center space-x-4 w-full md:w-auto">
            <div className="bg-[#F39200]/15 backdrop-blur-sm p-4 rounded-xl border border-[#F39200]/30">
              <Award className="h-10 w-10 text-[#F39200]" />
            </div>
            <div>
          ...
          <div className="flex flex-wrap gap-3">
            <Link to={ROUTES.BADGE}>
              <Button variant="outline" size="lg" className="border-[#F39200]/40 text-[#F39200] hover:bg-[#F39200]/10">
                {t('partner.virtual_badge')}
              </Button>
            </Link>
            <Link to={ROUTES.PARTNER_ANALYTICS}>
              <Button size="lg" className="bg-[#F39200] text-[#0F2034] hover:bg-[#A88830] font-bold">
