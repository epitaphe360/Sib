...
export const Footer: React.FC = memo(() => {
  ...
  return (
    <footer className="bg-[#0A0A0A] text-white relative overflow-hidden font-sans border-t border-[rgba(231,209,146,0.1)]">
      <div className="absolute inset-0 pointer-events-none opacity-[0.025]" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, rgba(231,209,146,0.8) 1px, transparent 0)', backgroundSize: '32px 32px' }}></div>
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[1000px] h-[300px] bg-[#E7D192]/3 rounded-full blur-[120px] pointer-events-none"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16 border-b border-[rgba(231,209,146,0.08)]">
            ...
            <div className="flex gap-3">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  title={social.label}
                  aria-label={social.label}
                  className="h-12 w-12 rounded-sm bg-white/5 border border-[rgba(231,209,146,0.12)] flex items-center justify-center text-white/40 hover:text-[#E7D192] hover:bg-[rgba(231,209,146,0.06)] hover:border-[rgba(231,209,146,0.4)] transition-all group"
                >
          ...
          <div className="lg:col-span-2">
            <h3 className="text-[10px] font-light text-[#E7D192] uppercase tracking-[0.3em] mb-8">{t('footer.navigation')}</h3>
            <ul className="space-y-4">
              {[
                ...
                <li key={link.label}>
                  <Link to={link.href} className="text-white/40 hover:text-[#E7D192] font-light text-sm tracking-tight transition-colors">{link.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            <h3 className="text-[10px] font-light text-[#E7D192] uppercase tracking-[0.3em] mb-8">{t('footer.media_platform')}</h3>
            <ul className="space-y-4">
              {[
          ...
          <div className="lg:col-span-4">
            <h3 className="text-[10px] font-light text-[#E7D192] uppercase tracking-[0.3em] mb-8">{t('footer.strategic_contact')}</h3>
            <div className="bg-white/3 border border-[rgba(231,209,146,0.12)] rounded-sm p-8 space-y-6">
              <div className="flex items-start gap-4">
                <div className="h-10 w-10 shrink-0 bg-[rgba(231,209,146,0.08)] border border-[rgba(231,209,146,0.2)] rounded-sm flex items-center justify-center">
                  <MapPin className="h-5 w-5 text-[#E7D192]" />
                </div>
                <div>
              ...
              <div className="flex items-center gap-4">
                <div className="h-10 w-10 shrink-0 bg-[rgba(231,209,146,0.08)] border border-[rgba(231,209,146,0.2)] rounded-sm flex items-center justify-center">
                  <Mail className="h-5 w-5 text-[#E7D192]" />
                </div>
              ...
              <div className="flex items-center gap-4">
                <div className="h-10 w-10 shrink-0 bg-[rgba(231,209,146,0.08)] border border-[rgba(231,209,146,0.2)] rounded-sm flex items-center justify-center">
                  <Phone className="h-5 w-5 text-[#E7D192]" />
                </div>
        ...
        <div className="pt-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white/25 text-[10px] font-light uppercase tracking-[0.3em]">
            © {currentYear} SIB GLOBAL SYMPOSIUM. {t('footer.all_rights').toUpperCase()}.
          </div>
          <div className="flex items-center gap-8">
            <Link to={ROUTES.PRIVACY} className="text-white/25 hover:text-[#E7D192] text-[10px] font-light uppercase tracking-widest transition-colors">{t('footer.privacy')}</Link>
            <Link to={ROUTES.TERMS} className="text-white/25 hover:text-[#E7D192] text-[10px] font-light uppercase tracking-widest transition-colors">{t('footer.legal')}</Link>
            <Link to={ROUTES.COOKIES} className="text-white/25 hover:text-[#E7D192] text-[10px] font-light uppercase tracking-widest transition-colors">Cookies</Link>
            <div className="flex items-center gap-2 px-3 py-1 bg-white/3 rounded-sm border border-[rgba(231,209,146,0.1)]">
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></div>
              <span className="text-[9px] font-light text-emerald-400 uppercase tracking-wide">System Active</span>
            </div>
          </div>
        </div>
      </div>
