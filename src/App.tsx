...
const EmailTemplatesManager = lazyRetry(() => import('./pages/admin/EmailTemplatesManager'));
...
// Modules — location, chapiteau, publicité, catalogue, équipe, factures
...
function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SkipToContent />
      {!isUrbaRoute && !isStandaloneHome && <HautPatronageBar />}
      ...
      <main
        ...
        className={
          isStandaloneHome
            ? 'flex-1 p-0'
            : `flex-1 ${isUrbaRoute ? 'pt-[66px]' : 'pt-28 sm:pt-32 xl:pt-40'}`
        }
      >
        {children}
      </main>
    ...
    <ErrorBoundary>
      ...
      <AppShell>
          <Suspense fallback={
            ...
            <Routes>
            <Route path={ROUTES.HOME} element={<Sib2026HomeV4Page />} />
            <Route path="/accueil/*" element={<Navigate to={ROUTES.HOME} replace />} />
            <Route path="/home/*" element={<Navigate to={ROUTES.HOME} replace />} />
            <Route path="/design/menu-accueil" element={<Navigate to={ROUTES.HOME} replace />} />

            {/* Pages publiques — Le Salon / Exposer / Visiter */}
            ...
            <Route path={ROUTES.CHAPITEAU_CHECKOUT} element={<ProtectedRoute requiredRole={['exhibitor', 'partner']}><ChapiteauCheckoutPage /></ProtectedRoute>} />
            <Route path={ROUTES.CHAPITEAU_PAYMENT_SUCCESS} element={<ProtectedRoute requiredRole={['exhibitor', 'partner']}><ChapiteauPaymentSuccessPage /></ProtectedRoute>} />
            <Route path={ROUTES.EXHIBITOR_CHAPITEAU} element={<ProtectedRoute requiredRole="exhibitor"><ChapiteauCatalogPage /></ProtectedRoute>} />
            <Route path={ROUTES.PARTNER_CHAPITEAU} element={<ProtectedRoute requiredRole="partner"><ChapiteauCatalogPage /></ProtectedRoute>} />
            <Route path={ROUTES.RENTAL_CATALOG} element={<ProtectedRoute requiredRole={['exhibitor', 'partner']}><RentalCatalogPage /></ProtectedRoute>} />
            <Route path={ROUTES.RENTAL_CHECKOUT} element={<ProtectedRoute requiredRole={['exhibitor', 'partner']}><RentalCheckoutPage /></ProtectedRoute>} />
            <Route path={ROUTES.RENTAL_PAYMENT_SUCCESS} element={<ProtectedRoute requiredRole={['exhibitor', 'partner']}><RentalPaymentSuccessPage /></ProtectedRoute>} />
            <Route path={ROUTES.EXHIBITOR_RENTAL} element={<ProtectedRoute requiredRole="exhibitor"><Navigate to={ROUTES.RENTAL_CATALOG} replace /></ProtectedRoute>} />
            <Route path={ROUTES.PARTNER_RENTAL} element={<ProtectedRoute requiredRole="partner"><Navigate to={ROUTES.RENTAL_CATALOG} replace /></ProtectedRoute>} />
            <Route path={ROUTES.EXHIBITOR_ADVERTISING} element={<ProtectedRoute requiredRole="exhibitor"><AdvertisingCatalogPage /></ProtectedRoute>} />
            <Route path={ROUTES.PARTNER_ADVERTISING} element={<ProtectedRoute requiredRole="partner"><AdvertisingCatalogPage /></ProtectedRoute>} />
            ...
            {/* Catalogue exposants (token public) */}
            ...
            <Route path={ROUTES.INVITATION_LETTER} element={<ProtectedRoute requiredRole={['exhibitor', 'partner']}><InvitationLetterPage /></ProtectedRoute>} />
            ...
            <Route path={ROUTES.ADMIN_SESSION_CHECKIN} element={<ProtectedRoute requiredRole={['admin', 'security']}><SessionCheckinPage /></ProtectedRoute>} />
            ...
            <Route path={ROUTES.DEV_TEST_FLOW} element={<Navigate to={ROUTES.HOME} replace />} />
