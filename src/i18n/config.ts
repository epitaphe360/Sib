    ...
    translation: {
      ...
      marketing: {
        ...
        articles: {
          ...
          subtitle: 'Créez et gérez les articles pour sib2026.ma',
          ...
          shortcodes_desc: 'Copiez le shortcode d\'un article et collez-le dans n\'importe quelle page de sib2026.ma. L\'article s\'affichera automatiquement avec sa mise en forme.',
          example: 'Exemple :',
      ...
      accommodation: {
        ...
        title: 'Hébergement à Casablanca',
      ...
      countdown: {
        ...
        venue: 'Venue',
        address: 'Adresse',
        event_address: 'Route de Casablanca, Casablanca 24000, Maroc',
        schedule: 'Horaires',
        ...
        share_text: '🚢 SIB 2026 - Salon International du B�timent\n📅 {{dates}}\n📍 {{location}}\n\n⏰ Plus que {{days}} jours, {{hours}} heures !\n\n🌐 https://sib2026.ma',
        copied_clipboard: '🔗 Compte à rebours copié dans le presse-papiers !',
        copy_failed: 'Impossible de copier',
        add_to_calendar: 'Ajouter au Calendrier',
        calendar_description: 'Le plus grand salon portuaire international - 300+ exposants, 6,000+ visiteurs de 40 pays',
  ...
  en: {
    translation: {
      ...
      accommodation: {
        ...
        title: 'Accommodation in Casablanca',
      ...
      countdown: {
        ...
        venue: 'Venue',
        address: 'Address',
        event_address: 'Route de Casablanca, Casablanca 24000, Morocco',
        schedule: 'Schedule',
      ...
      marketing: {
        ...
        articles: {
          ...
          subtitle: 'Create and manage articles for sib2026.ma',
          create_new: 'Create New Article',
          published_count: 'Published',
          drafts_count: 'Drafts',
          shortcodes_info: 'Using Shortcodes',
          shortcodes_desc: 'Copy an article shortcode and paste it into any sib2026.ma page. The article will automatically display with its formatting.',
          example: 'Example:',
