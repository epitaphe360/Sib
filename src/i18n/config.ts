  ...
  fr: {
    translation: {
      ...
      admin: {
        ...
        visitor_pricing: {
          title: 'Tarif Pass VIP Premium',
          desc: 'Montant affiché sur le site, l’app mobile et les demandes de paiement',
          short_link: 'Tarif Pass VIP',
          current: 'Tarif actuel',
          new_price: 'Nouveau prix (EUR TTC)',
          hint: 'Appliqué aux niveaux premium et vip. Les inscriptions en cours conservent le montant de leur demande.',
          save: 'Enregistrer le tarif',
          saving: 'Enregistrement…',
          loading: 'Chargement du tarif…',
          saved: 'Tarif VIP mis à jour',
          save_error: 'Impossible d’enregistrer le tarif',
          load_error: 'Impossible de charger le tarif VIP',
          invalid_price: 'Saisissez un montant valide supérieur à 0',
          updated_at: 'Dernière modification : {{date}}',
        },
  ...
  en: {
    translation: {
      ...
      admin: {
        ...
        visitor_pricing: {
          title: 'Premium VIP Pass Price',
          desc: 'Amount shown on the website, mobile app, and payment requests',
          short_link: 'VIP Pass Price',
          current: 'Current price',
          new_price: 'New price (EUR incl. tax)',
          hint: 'Applied to premium and vip levels. Pending payment requests keep their original amount.',
          save: 'Save price',
          saving: 'Saving…',
          loading: 'Loading price…',
          saved: 'VIP price updated',
          save_error: 'Could not save price',
          load_error: 'Could not load VIP price',
          invalid_price: 'Enter a valid amount greater than 0',
