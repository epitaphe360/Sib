/**
 * Traductions pour les rendez-vous
 */
...
export const appointmentsTranslations = {
  fr: {
    ...
    'appointments.subtitle': 'Gérez vos rencontres professionnelles',
    'appointments.book': 'Réserver un rendez-vous',
    'appointments.my_appointments': 'Mes rendez-vous',
    ...
    'appointments.calendar.week': 'Semaine',
    'appointments.calendar.month': 'Mois',
    'appointments.calendar.today': 'Aujourd\'hui',
    'appointments.calendar.select_date': 'Sélectionner une date',
    'appointments.calendar.select_time': 'Sélectionner une heure',
    ...
    'appointments.slots.duration': 'Durée : {{duration}} min',
    'appointments.slots.select': 'Sélectionner ce créneau',
    'appointments.slots.generate': 'Générer des créneaux',
    'appointments.slots.bulk_create': 'Création en masse',
    ...
    'appointments.book.date': 'Date',
    'appointments.book.time': 'Heure',
    'appointments.book.duration': 'Durée',
    'appointments.book.subject': 'Sujet',
    'appointments.book.message': 'Message (optionnel)',
    'appointments.book.notes': 'Notes',
    ...
    'appointments.detail.date': 'Date',
    'appointments.detail.time': 'Heure',
    'appointments.detail.duration': 'Durée',
    'appointments.detail.location': 'Lieu',
    'appointments.detail.booth': 'Stand',
    'appointments.detail.room': 'Salle',
    'appointments.detail.online': 'En ligne',
    ...
    'appointments.action.reschedule': 'Reprogrammer',
    'appointments.action.edit': 'Modifier',
    'appointments.action.delete': 'Supprimer',
    ...
    'appointments.availability.edit': 'Modifier les disponibilités',
    'appointments.availability.timezone': 'Fuseau horaire',
    'appointments.availability.working_hours': 'Heures de travail',
    ...
    'appointments.quota.used': 'Utilisés',
    ...
    'appointments.filter.week': 'Cette semaine',
    'appointments.filter.month': 'Ce mois',
    'appointments.filter.status': 'Statut',
    'appointments.filter.type': 'Type',
  },
  en: {
    // General
    'appointments.title': 'Appointments',
    'appointments.subtitle': 'Manage your professional meetings',
    ...
    'appointments.calendar.select_date': 'Select date',
    'appointments.calendar.select_time': 'Select time',
    ...
    'appointments.slots.duration': 'Duration: {{duration}} min',
    'appointments.slots.select': 'Select this slot',
    'appointments.slots.generate': 'Generate slots',
    'appointments.slots.bulk_create': 'Bulk create',
    ...
    'appointments.book.date': 'Date',
    'appointments.book.time': 'Time',
    'appointments.book.duration': 'Duration',
    'appointments.book.subject': 'Subject',
    'appointments.book.message': 'Message (optional)',
    'appointments.book.notes': 'Notes',
    ...
    'appointments.detail.date': 'Date',
    'appointments.detail.time': 'Time',
    'appointments.detail.duration': 'Duration',
    'appointments.detail.location': 'Location',
    'appointments.detail.booth': 'Booth',
    'appointments.detail.room': 'Room',
    'appointments.detail.online': 'Online',
    ...
    'appointments.availability.edit': 'Edit availability',
    'appointments.availability.timezone': 'Timezone',
    'appointments.availability.working_hours': 'Working hours',
    ...
    'appointments.filter.week': 'This week',
