...
export const appointmentsTranslations = {
  ...
  ar: {
    ...
    'appointments.subtitle': 'إدارة اجتماعاتك المهنية',
    'appointments.book': 'حجز موعد',
    'appointments.my_appointments': 'مواعيدي',
    'appointments.upcoming': 'قادمة',
    'appointments.past': 'سابقة',
    ...
    'appointments.calendar.select_date': 'اختر تاريخًا',
    'appointments.calendar.select_time': 'اختر وقتًا',
    'appointments.calendar.available': 'متاح',
    'appointments.calendar.unavailable': 'غير متاح',
    'appointments.calendar.blocked': 'مغلق',
    'appointments.slots.available': 'الفتحات المتاحة',
    'appointments.slots.no_slots': 'لا توجد فتحات متاحة',
    'appointments.slots.duration': 'المدة: {{duration}} دقيقة',
    'appointments.slots.select': 'اختر هذه الفتحة',
    'appointments.slots.generate': 'إنشاء فتحات',
    'appointments.slots.bulk_create': 'الإنشاء الجماعي',
    ...
    'appointments.book.message': 'الرسالة (اختياري)',
    ...
    'appointments.detail.room': 'الغرفة',
    ...
    'appointments.status.no_show': 'لم يظهر',
    'appointments.availability.title': 'التوفر',
    'appointments.availability.set': 'تحديد توفري',
    'appointments.availability.edit': 'تعديل التوفر',
    'appointments.availability.timezone': 'المنطقة الزمنية',
    'appointments.availability.working_hours': 'ساعات العمل',
    'appointments.availability.breaks': 'فترات الراحة',
    ...
    'appointments.notification.confirmed': 'موعد مؤكد',
    'appointments.notification.cancelled': 'موعد ملغى',
    'appointments.notification.reminder': 'تذكير: موعد في {{time}}',
    'appointments.notification.starting_soon': 'موعدك يبدأ في 15 دقيقة',
    'appointments.quota.title': 'الحصص',
    'appointments.quota.remaining': 'متبقي',
    'appointments.quota.used': 'مستخدم',
