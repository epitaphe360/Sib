...
export const networkingTranslations = {
  fr: {
    ...
    'networking.error.invalid_dates': 'Ce créneau est en dehors des dates du salon (1-3 Avril 2026)',
  ...
  en: {
    ...
    'networking.error.invalid_dates': 'This slot is outside the event dates (April 1-3, 2026)',
  ...
  ar: {
    ...
    'networking.restricted': 'التواصل الذكي محجوز للزوار المميزين وVIP. يرجى ترقية حسابك.',
    'networking.error.loading_data': 'تعذّر تحميل بعض البيانات',
    'networking.error.generation': 'خطأ أثناء الإنشاء',
    'networking.error.search': 'خطأ أثناء البحث',
    'networking.error.profile_not_found': 'ملف المستخدم غير موجود',
    'networking.error.login_required': 'تسجيل الدخول مطلوب لحجز موعد',
    'networking.error.duplicate_appointment': 'لديك بالفعل موعد مع هذا العارض/الشريك',
    'networking.error.no_exhibitor': 'لم يُختر أي عارض',
    'networking.error.no_slot': 'يرجى اختيار موعد زمني',
    'networking.error.slot_taken': 'تم حجز هذا الموعد للتو من شخص آخر. يرجى اختيار موعد آخر.',
    'networking.error.duplicate_slot': 'لقد حجزت هذا الموعد بالفعل',
    'networking.error.past_slot': 'هذا الموعد في الماضي. يرجى اختيار موعد مستقبلي.',
    'networking.error.invalid_dates': 'هذا الموعد خارج تواريخ المعرض (1-3 أبريل 2026)',
    'networking.error.acceptance': 'خطأ أثناء القبول',
    'networking.error.refusal': 'خطأ أثناء الرفض',
    'networking.error.cancellation': 'خطأ أثناء الإلغاء',
    'networking.error.must_be_logged': 'يجب تسجيل الدخول',
    'networking.error.recommendations': 'خطأ في توليد التوصيات',
    'networking.success.generated': 'توصياتك جاهزة!',
    'networking.success.recommendations': 'تم توليد توصيات الذكاء الاصطناعي بنجاح!',
    'networking.success.appointment_created': 'تم إنشاء الموعد بنجاح',
    'networking.success.appointment_cancelled': 'تم إلغاء الموعد بنجاح',
    'networking.success.accepted': 'تم قبول الموعد',
    'networking.success.refused': 'تم رفض الموعد',
    'networking.confirm.cancel': 'هل أنت متأكد من إلغاء هذا الموعد؟',
    'networking.action.book': 'حجز موعد',
    'networking.action.cancel': 'إلغاء هذا الموعد',
    'networking.action.accept': 'قبول',
    'networking.action.refuse': 'رفض',
    'networking.action.generate_recommendations': 'توليد التوصيات',
    'networking.ai.assistant': 'SIB AI Assistant v3.0',
    'networking.ai.info': 'سجّل الدخول للوصول إلى الذكاء الاصطناعي الكامل مع التوصيات الذكية ومطابقة القطاعات وتحسين الجدول!',
    'networking.search.no_results': 'لم يُعثر على نتائج لبحثك',
    'networking.search.results_found': 'تم العثور على {{count}} ملف',
    'networking.generation.loading': '🤖 جارٍ توليد توصيات الذكاء الاصطناعي المخصصة...',
    'networking.error.quota_reached_free': 'وصول مقيّد: تذكرتك المجانية لا تسمح بمواعيد B2B. قم بالترقية إلى تذكرة VIP Premium لمواعيد B2B غير محدودة!',
    'networking.error.quota_reached_limit': 'تم استنفاد الحصة: لديك بالفعل {{count}} مواعيد B2B مؤكدة لمستواك.',
    'networking.success.request_sent': '✅ تم إرسال طلب الموعد إلى {{name}}!',
  },
};
