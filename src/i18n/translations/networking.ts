...
export const networkingTranslations = {
  ...
  ar: {
    ...
    'networking.restricted': 'التواصل الذكي مخصص للزوار المتميزين و VIP. يرجى ترقية حسابك.',
    'networking.error.loading_data': 'لم تتمكن بعض البيانات من التحميل',
    'networking.error.generation': 'خطأ أثناء الإنشاء',
    'networking.error.search': 'خطأ أثناء البحث',
    'networking.error.profile_not_found': 'لم يتم العثور على ملف المستخدم',
    'networking.error.login_required': 'التسجيل مطلوب لحجز موعد',
    'networking.error.duplicate_appointment': 'لديك بالفعل موعد مع هذا العارض/الشريك',
    'networking.error.no_exhibitor': 'لا يوجد عارض محدد',
    'networking.error.no_slot': 'يرجى تحديد فترة زمنية',
    'networking.error.slot_taken': 'تم حجز هذه الفترة للتو من قبل شخص آخر. يرجى اختيار أخرى.',
    'networking.error.duplicate_slot': 'لديك بالفعل حجز لهذه الفترة الزمنية',
    'networking.error.past_slot': 'هذه الفترة في الماضي. يرجى اختيار فترة مستقبلية.',
    'networking.error.invalid_dates': 'هذه الفترة خارج تواريخ الحدث (25-29 نوفمبر 2026)',
    ...
    'networking.error.must_be_logged': 'يجب أن تكون مسجلاً',
    'networking.error.recommendations': 'خطأ في إنشاء التوصيات',
    'networking.success.generated': 'توصياتك جاهزة!',
    'networking.success.recommendations': 'تم إنشاء توصيات الذكاء الاصطناعي بنجاح!',
    ...
    'networking.confirm.cancel': 'هل أنت متأكد من رغبتك في إلغاء هذا الموعد؟',
    ...
    'networking.action.generate_recommendations': 'إنشاء توصيات',
    'networking.ai.assistant': 'SIB AI Assistant v3.0',
    'networking.ai.info': 'سجل الدخول للوصول إلى الذكاء الاصطناعي الكامل مع توصيات ذكية ومطابقة القطاع وتحسين الجدول الزمني!',
    'networking.search.no_results': 'لم يتم العثور على نتائج لبحثك',
    'networking.search.results_found': '{{count}} ملف(ات) موجود(ة)',
    'networking.generation.loading': '🤖 إنشاء توصياتك الشخصية بالذكاء الاصطناعي...',
    'networking.error.quota_reached_free': 'وصول مقيد: لا يسمح لك بطاقتك المجانية بحجز مواعيد B2B. ارقَ إلى بطاقة Premium VIP للمواعيد B2B غير المحدودة!',
    'networking.error.quota_reached_limit': 'تم الوصول إلى الحد: لديك بالفعل {{count}} مواعيد B2B مؤكدة لمستواك.',
    'networking.success.request_sent': '✅ تم إرسال طلب موعد إلى {{name}}!',
  },
};
