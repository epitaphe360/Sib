...
export const accommodationTranslations = {
  ...
  ar: {
    'accommodation.title': 'الإقامة والفنادق الشريكة',
    'accommodation.subtitle': 'استمتع بأسعار مفضلة تم التفاوض عليها حصريًا لمشاركي SIB',
    'accommodation.badge': 'الفنادق الشريكة',
    'accommodation.hotels_partners': 'الفنادق الشريكة',
    'accommodation.vip_discount': 'خصم VIP',
    'accommodation.april_dates': 'نوفمبر 2026',
    'accommodation.vip_advantage_title': 'مزايا VIP والبريميوم',
    'accommodation.vip_advantage_desc': 'من خلال الحجز عبر منصتنا برمزك الفريد، تستفيد من:',
    'accommodation.vip_benefit_1': 'أسعار مخفضة تصل إلى -20% من السعر العام',
    'accommodation.vip_benefit_2': 'ترقية حسب التوفر',
    'accommodation.vip_benefit_3': 'نقل مجاني إلى مكان الحدث',
    'accommodation.featured_partner': 'شريك بريميوم',
    'accommodation.standard_rate': 'السعر القياسي',
    'accommodation.vip_rate': 'سعر SIB VIP',
    'accommodation.per_night': 'في الليلة',
    'accommodation.book_now': 'احجز الآن',
    'accommodation.contact_hotel': 'اتصل بالفندق',
    'accommodation.website': 'الموقع الإلكتروني',
    'accommodation.details': 'التفاصيل والأسعار',
    'accommodation.amenities': 'التسهيلات',
    'accommodation.location': 'الموقع',
    'accommodation.amenity_wifi': 'Wi-Fi عالي السرعة',
    'accommodation.amenity_parking': 'موقف سيارات مجاني',
    'accommodation.amenity_pool': 'حمام سباحة',
    'accommodation.amenity_spa': 'منتجع صحي والعافية',
    'accommodation.amenity_restaurant': 'مطعم',
    'accommodation.amenity_gym': 'صالة الألعاب الرياضية',
    'accommodation.amenity_casino': 'كازينو',
    'accommodation.amenity_beach': 'الوصول إلى الشاطئ',
    'accommodation.amenity_golf': 'الجولف',
    'accommodation.amenity_bar': 'حانة / لاونج',
    'accommodation.amenity_terrace': 'التراس',
    'accommodation.hotel.pullman.desc': 'مجمع فاخر مع ملعب جولف بـ 18 حفرة وحمام صحي فاخر وإمكانية الوصول المباشر للشاطئ',
    'accommodation.hotel.ibis.desc': 'فندق حديث مريح بنسبة جودة سعر ممتازة',
    'accommodation.hotel.mazagan.desc': 'منتجع 5 نجوم مع كازينو وشاطئ خاص ومطاعم فاخرة متعددة',
    'accommodation.hotel.royal.desc': 'فندق أنيق يقع على ملعب جولف مع إطلالات بانورامية',
    'accommodation.hotel.suisse.desc': 'فندق عائلي مع خدمة شخصية في قلب الجديدة',
    'accommodation.hotel.provence.desc': 'سحر متوسطي مع تراس بانورامي',
    'accommodation.dist.5km': '5 كم من المكان',
    'accommodation.dist.3km': '3 كم من المكان',
    'accommodation.dist.6km': '6 كم من المكان',
    'accommodation.dist.4km': '4 كم من المكان',
    'accommodation.dist.2km': '2 كم من المكان',
    'accommodation.dist.2.5km': '2.5 كم من المكان',
    'accommodation.room.deluxe_single': 'غرفة ديلوكس سرير فردي',
    'accommodation.room.deluxe_double': 'غرفة ديلوكس سرير مزدوج',
    'accommodation.room.suite_junior_single': 'جونيور سويت سرير فردي',
    'accommodation.room.suite_junior_double': 'جونيور سويت سرير مزدوج',
    'accommodation.room.garden_pool_single': 'غرفة إطلالة حديقة وحمام سباحة (فردي)',
    'accommodation.room.garden_pool_double': 'غرفة إطلالة حديقة وحمام سباحة (مزدوج)',
    'accommodation.room.suite_partial_ocean': 'جناح إطلالة المحيط الجزئية',
    'accommodation.room.suite_full_ocean': 'جناح إطلالة المحيط الكاملة',
  }
};