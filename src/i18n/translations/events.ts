/**
 * Traductions pour les événements
 */
...
export const eventsTranslations = {
  fr: {
    ...
    'events.subtitle': 'Conférences, ateliers et activités du salon',
    'events.search': 'Chercher un événement',
    'events.all': 'Tous les événements',
    'events.upcoming': 'À venir',
    'events.today': 'Aujourd\'hui',
    'events.tomorrow': 'Demain',
    'events.this_week': 'Cette semaine',
    ...
    'events.type.panel': 'Table ronde',
    'events.type.roundtable': 'Table ronde',
    'events.type.networking': 'Réseautage',
    'events.type.ceremony': 'Cérémonie',
    ...
    'events.detail.duration': 'Durée',
    'events.detail.location': 'Lieu',
    'events.detail.capacity': 'Capacité',
    'events.detail.available_seats': 'Places disponibles',
    'events.detail.speaker': 'Intervenant',
    'events.detail.speakers': 'Intervenants',
    'events.detail.moderator': 'Modérateur',
    'events.detail.description': 'Description',
    'events.detail.agenda': 'Programme',
    ...
    'events.register.cancel': 'Annuler l\'inscription',
    'events.register.success': 'Inscription confirmée !',
    'events.register.error': 'Erreur lors de l\'inscription',
    ...
    'events.add_to_calendar': 'Ajouter au calendrier',
    ...
    'events.status.postponed': 'Reporté',
    ...
    'events.notification.cancelled': '{{event}} a été annulé',
    'events.notification.updated': '{{event}} a été mis à jour',
  },
  en: {
    // Event pages
    'events.title': 'Events',
    'events.subtitle': 'Conferences, workshops and activities',
    ...
    'events.type.panel': 'Panel discussion',
    'events.type.roundtable': 'Round table',
    'events.type.networking': 'Networking',
    'events.type.ceremony': 'Ceremony',
    ...
    'events.detail.available_seats': 'Available seats',
    'events.detail.speaker': 'Speaker',
    'events.detail.speakers': 'Speakers',
    'events.detail.moderator': 'Moderator',
    'events.detail.description': 'Description',
    ...
    'events.register.cancel': 'Cancel registration',
    'events.register.success': 'Registration confirmed!',
    'events.register.error': 'Registration error',
