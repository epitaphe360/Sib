...
export const eventsTranslations = {
  ...
  ar: {
    ...
    'events.subtitle': 'المؤتمرات والورش والأنشطة',
    'events.search': 'ابحث عن حدث',
    ...
    'events.detail.available_seats': 'المقاعد المتاحة',
    'events.detail.speaker': 'المتحدث',
    'events.detail.speakers': 'المتحدثون',
    'events.detail.moderator': 'المشرف',
    ...
    'events.register.title': 'التسجيل للحدث',
    'events.register.confirm': 'تأكيد التسجيل',
    'events.register.cancel': 'إلغاء التسجيل',
    'events.register.success': 'تم التسجيل بنجاح!',
    'events.register.error': 'خطأ في التسجيل',
    'events.register.full_message': 'هذا الحدث ممتلئ',
    'events.register.deadline_passed': 'انتهت آخر موعد',
    'events.register.already_registered': 'أنت بالفعل مسجل',
    'events.filter.date': 'التاريخ',
    'events.filter.type': 'النوع',
    'events.filter.location': 'الموقع',
    'events.filter.language': 'اللغة',
    'events.filter.free_seats': 'المقاعد المتاحة',
    'events.my_events': 'أحداثي',
    ...
    'events.program.business': 'برنامج العمل',
    'events.program.social': 'برنامج اجتماعي',
    'events.program.download': 'تحميل البرنامج',
    'events.status.scheduled': 'مجدول',
    'events.status.in_progress': 'جاري',
    ...
    'events.admin.manage': 'إدارة الأحداث',
    'events.admin.create': 'إنشاء حدث',
    'events.admin.edit': 'تعديل الحدث',
    'events.admin.loading_error': 'فشل تحميل الأحداث. يرجى المحاولة لاحقًا.',
    'events.notification.starts_soon': 'الحدث يبدأ في {{time}}',
    'events.notification.reminder': 'تذكير: {{event}} غدًا في {{time}}',
