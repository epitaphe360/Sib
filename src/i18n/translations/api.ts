...
export const apiTranslations = {
  ...
  ar: {
    'api.title': 'SIB API',
    'api.subtitle': 'دمج بيانات SIB 2026 في تطبيقاتك',
    'api.description': 'API RESTful كاملة للوصول إلى العارضين والأحداث والوسائط والمزيد.',
    'api.nav.overview': 'نظرة عامة',
    'api.nav.authentication': 'المصادقة',
    'api.nav.endpoints': 'نقاط النهاية',
    'api.nav.examples': 'أمثلة',
    'api.nav.rate_limits': 'حدود المعدل',
    'api.nav.support': 'الدعم',
    'api.overview.title': 'نظرة عامة',
    'api.overview.description': 'توفر API SIB وصولاً برمجياً إلى بيانات الحدث.',
    'api.overview.base_url': 'عنوان URL الأساسي',
    'api.overview.version': 'الإصدار',
    'api.overview.format': 'التنسيق',
    'api.features.title': 'الميزات',
    'api.features.restful': 'RESTful API',
    'api.features.restful_desc': 'معمارية REST القياسية مع طرق HTTP',
    'api.features.realtime': 'الوقت الفعلي',
    'api.features.realtime_desc': 'WebSocket لتحديثات الوقت الفعلي',
    'api.features.secure': 'آمن',
    'api.features.secure_desc': 'المصادقة JWT و HTTPS إلزامية',
    'api.features.documented': 'موثق',
    'api.features.documented_desc': 'وثائق كاملة مع أمثلة',
    'api.auth.title': 'المصادقة',
    'api.auth.description': 'تستخدم API رموز JWT للمصادقة.',
    'api.auth.get_token': 'الحصول على رمز',
    'api.auth.use_token': 'استخدام الرمز',
    'api.auth.header': 'رأس المصادقة',
    'api.auth.expires': 'انتهاء الصلاحية',
    ...
    'api.endpoints.events': 'الأحداث',
    'api.endpoints.events_desc': 'المؤتمرات والورش والبرامج',
    'api.endpoints.partners': 'الشركاء',
    'api.endpoints.partners_desc': 'المنظمات الشريكة',
    'api.endpoints.media': 'الوسائط',
    'api.endpoints.media_desc': 'الندوات عبر الويب والبودكاست والفيديوهات',
    'api.endpoints.appointments': 'المواعيد',
    'api.endpoints.appointments_desc': 'إدارة فتحات الوقت',
    'api.methods.get': 'GET - استرجاع البيانات',
    ...
    'api.responses.title': 'الردود',
    'api.responses.success': 'النجاح (200-299)',
    'api.responses.error': 'الخطأ (400-599)',
    'api.responses.format': 'صيغة الرد',
    'api.limits.title': 'حدود المعدل',
    'api.limits.description': 'يحمي API من الإساءة',
    'api.limits.requests': 'طلبات في الساعة',
    'api.limits.exceeded': 'إذا تم تجاوز الحد',
    ...
    'api.support.documentation': 'الوثائق الكاملة',
    'api.support.contact': 'اتصل بنا',
