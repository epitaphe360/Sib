...
export const authTranslations = {
  fr: {
    ...
    'auth.login.subtitle': 'Accédez à votre compte SIB',
    ...
    'auth.register.subtitle': 'Rejoignez SIB 2026',
    ...
    'auth.error.required_field': 'Ce champ est requis',
    ...
    'auth.status.inactive': 'Inactif',
    'auth.status.suspended': 'Suspendu',
  },
  en: {
    // Login pages
    'auth.login': 'Login',
    'auth.login.title': 'Log in',
    'auth.login.subtitle': 'Access your SIB account',
    ...
    'auth.register.subtitle': 'Join SIB 2026',
    ...
    'auth.error.required_field': 'This field is required',
