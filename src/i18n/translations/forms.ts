...
export const formsTranslations = {
  ...
  ar: {
    ...
    'form.too_short': 'قصير جداً ({{min}} أحرف على الأقل)',
    'form.too_long': 'طويل جداً ({{max}} أحرف كحد أقصى)',
    'form.invalid_format': 'تنسيق غير صالح',
    ...
    'form.email.exists': 'هذا البريد الإلكتروني مستخدم بالفعل',
    'form.email.not_found': 'البريد الإلكتروني غير موجود',
    'form.password.required': 'كلمة المرور مطلوبة',
    'form.password.min_length': '{{min}} أحرف على الأقل',
    'form.password.max_length': '{{max}} أحرف كحد أقصى',
    'form.password.uppercase': 'حرف كبير واحد على الأقل',
    'form.password.lowercase': 'حرف صغير واحد على الأقل',
    'form.password.number': 'رقم واحد على الأقل',
    'form.password.special': 'رمز خاص واحد على الأقل',
    'form.password.no_match': 'كلمتا المرور غير متطابقتين',
    'form.phone.invalid': 'رقم هاتف غير صالح',
    'form.phone.required': 'الهاتف مطلوب',
    'form.phone.format': 'التنسيق: +237 6XX XX XX XX',
    'form.url.invalid': 'رابط URL غير صالح',
    'form.url.format': 'التنسيق: https://example.com',
    ...
    'form.file.too_large': 'الملف كبير جداً (الحد الأقصى {{size}})',
    'form.file.invalid_type': 'نوع ملف غير مدعوم',
    'form.file.upload_error': 'خطأ في الرفع',
    'form.number.invalid': 'رقم غير صالح',
    'form.number.min': 'الحد الأدنى: {{min}}',
    'form.number.max': 'الحد الأقصى: {{max}}',
    'form.number.positive': 'يجب أن يكون موجباً',
    'form.number.integer': 'يجب أن يكون عدداً صحيحاً',
    'form.select.required': 'يرجى الاختيار',
    'form.select.placeholder': 'اختر...',
    'form.select.no_options': 'لا توجد خيارات متاحة',
    'form.select.search': 'بحث...',
    'form.checkbox.required': 'يجب تحديد هذا المربع',
    'form.terms.required': 'يجب قبول الشروط والأحكام',
    'form.privacy.required': 'يجب قبول سياسة الخصوصية',
    ...
    'form.error.timeout': 'انتهت مهلة الانتظار',
    'form.error.unauthorized': 'غير مصرح',
    'form.error.forbidden': 'الوصول مرفوض',
    'form.error.not_found': 'غير موجود',
    'form.error.max_items': '{{max}} عناصر كحد أقصى',
    ...
    'form.status.processing': 'جارٍ المعالجة...',
    'form.status.uploading': 'جارٍ الرفع...',
    ...
    'form.helper.remaining': '{{count}} متبقٍ',
  },
};
