...
export const dashboardTranslations = {
  ...
  ar: {
    ...
    // Admin - إدارة الصالونات
    'admin.salons_title': 'إدارة الصالونات',
    'admin.salons_subtitle': 'إنشاء وإدارة إصدارات المعرض',
    'admin.salons_new': 'صالون جديد',
    'admin.salons_active': 'الصالونات النشطة',
    'admin.salons_default': 'الصالون الافتراضي',
    'admin.salons_empty': 'لم يتم إنشاء أي صالون',
    'admin.salons_load_error': 'خطأ في التحميل: ',
    'admin.salons_upload_error': 'خطأ في الرفع: ',
    'admin.salons_name_slug_required': 'الاسم والرابط مطلوبان.',
    'admin.salons_updated': 'تم تحديث الصالون.',
    'admin.salons_created': 'تم إنشاء الصالون.',
    'admin.salons_toggled': 'تم تحديث الصالون:',
    'admin.salons_activated': 'مفعّل',
    'admin.salons_deactivated': 'معطّل',
    'admin.salons_set_default': 'تعيين كافتراضي',
    'admin.salons_unset_default': 'إلغاء الافتراضي',
    'admin.salons_delete_confirm': 'حذف الصالون "{name}"؟ هذا الإجراء لا رجعة فيه.',
    'admin.salons_deleted': 'تم حذف الصالون.',
    'admin.salons_modal_edit': 'تعديل الصالون',
    'admin.salons_modal_create': 'إنشاء صالون',
