...
| A7 | Admin = email + mot de passe Supabase + membership `lab` | MFA : colonnes prêtes, enrollment plus tard. |
...
| A15 | Emails : templates en table, envoi Resend plus tard | Pas de clé Resend dans le frontend. |
