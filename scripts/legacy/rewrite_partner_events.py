...
with open('src/pages/partners/PartnerEventsPage.tsx', 'rb') as f:
    raw = f.read()

# Normaliser les fins de lignes \r\r\n -> \n
content = raw.replace(b'\r\r\n', b'\n').replace(b'\r\n', b'\n').replace(b'\r', b'\n')
text = content.decode('utf-8')

new_content = r"""import React, { useEffect, useState } from 'react';
...
with open('src/pages/partners/PartnerEventsPage.tsx', 'w', encoding='utf-8', newline='\n') as f:
    f.write(new_content)

print("Fichier réécrit avec succès")
